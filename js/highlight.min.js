...
function openWhatsApp() {
    // Change the number and message as needed
    const phoneNumber = '6382034890'; // Country code + number (no '+' sign)
    const message = encodeURIComponent('lets make something amazing together start');
